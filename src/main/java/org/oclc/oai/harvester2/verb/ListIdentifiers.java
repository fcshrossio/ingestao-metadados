...
//    TransformerException {
    ...
    throws TransformerException, NoSuchFieldException {
        String tkStr = getSingleString("//ListIdentifiers/resumptionToken");
        if (tkStr==null || tkStr.isEmpty()) 
            tkStr = getSingleString("//oai20:ListIdentifiers/oai20:resumptionToken");
        return tkStr;
...
//        } else {
//            return getSingleString("//ListIdentifiers/resumptionToken");
